...
def main():
    ...
    # Opening of the screen with the Maze at the top and message space at the bottom (70px height).
    ...
    screen.blit(MESSAGE_WELCOME, (40, 615)) # Blitting the message at a special position.

    # Creation of instances : MacGyver, the Maze and the 3 objects (calling mmg_classes.py).
    maze = Maze()
    ...
    while cont: # The game is playing while the variable cont is "1" and stops when "0".
        ...
        # Blitting the floor and the Maze (walls, jail, Murdoc, exit gate) at the screen's top.
